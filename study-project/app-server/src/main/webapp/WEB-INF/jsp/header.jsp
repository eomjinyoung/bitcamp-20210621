...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="${contextPath}/app/home">PMS</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="${contextPath}/app/project/list">프로젝트</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="${contextPath}/app/task/list">작업</a>
        </li>
      </ul>
      <form class="d-flex">
